box(title = "1. Reference dataset", width = 12, solidHeader = T, status = "primary", 
    fluidRow(
        ...
        column(3, p(HTML("<b>1a. Use default references</b>"),
            ...
            the reference spectra, the definition of secondary structure elements,
            and the definition of tertiary structure elements (optional).
            ",placement = "right"))
        ),

        conditionalPanel("!input.useDefaultReferenceSetGQuad",
        ...
        conditionalPanel("!input.useDefaultReferenceSetGQuad",
            column(3, p(HTML('<p style="margin-bottom:0px;">Example spectra<br></p>'),
                downloadButton("download_reference_csv", "Download"))
            ),
            column(3, p(HTML('<p style="margin-bottom:0px;">Example sec. params<br></p>'),
                downloadButton("download_reference_sec_csv", "Download"))
            ),
            column(3, p(HTML('<p style="margin-bottom:0px;">Example ter. params<br></p>'),
